...
conditional_branch* parse_if(token_list& Token_list, int& index) {
...
conditional_branch* parse_else(token_list& Token_list, int& index) {
...
conditional_branches* parse_ifs(token_list& Token_list, int& index) {
